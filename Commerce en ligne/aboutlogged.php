  ...
  <section class="about_section layout_padding">
    <div class="container">
      ...
      <div class="detail-box">
        <p>
          Dweya est une platforme de vente en ligne de medicaments élaboré par deux etudiants de l'Enit afin de faciliter l'achats des produits medicales en ligne et donnés la possibilités au utilisateurs de passer des commmandes en ligne.
        </p>
