   ...
   <section class="about_section layout_padding">
    <div class="container">
      ...
      <div class="detail-box">
        <p>
        Dweya est une platforme de vente en ligne de medicaments élaboré par un etudiant de l'ISTIC afin de faciliter l'achats des produits medicales en ligne et donnés la possibilités au utilisateurs de passer des commmandes en ligne.
        </p>
        ...
        <div class="col-md-3">
          <div class="info_menu">
            ...
            <ul class="navbar-nav  ">
              ...
              <li class="nav-item">
                <a class="nav-link" href="loaboutlogged.php"> A propos </a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="medicinelogged.php"> Medicaments </a>
              </li>
