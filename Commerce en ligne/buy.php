...
if ($_SERVER['REQUEST_METHOD'] == 'POST'){
  ...
  $result = $connexion->query("SELECT * FROM article WHERE design = '$design'");
...
<body class="sub_page">
  ...
  <div class="health_carousel-container">
        ...
        <div class="item">
          <div class="box">
            ...
            <div class="detail-box">
              ...
              <div class="text">
                <h6>
                <input type="hidden" name="design" value="'.$i['design'].'" /> 
                '.$i['design'].'
                </h6>
                <h6 class="price">
                  <span>
      ...
      ';
      $_SESSION["id_article"]=$i['id_article'];
      $_SESSION["quantite"]=1;
      $_SESSION["prix_unit"]=$i['prix'];
      $_SESSION["design"]=$i['design'];
