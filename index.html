...
<head>
  ...
  <!-- bootstrap core css -->
  <link rel="stylesheet" type="text/css" href="Commerce en ligne/css/bootstrap.css" />

  <!-- fonts style -->
  <link href="https://fonts.googleapis.com/css?family=Poppins:400,600,700|Roboto:400,700&display=swap" rel="stylesheet">

  <!-- Custom styles for this template -->
  <link href="Commerce en ligne/css/style.css" rel="stylesheet" />
  <!-- responsive style -->
  <link href="Commerce en ligne/css/responsive.css" rel="stylesheet" />
</head>
...
<body>
              ...
              <div class="row">
                ...
                <div class="col-md-8">
                  <div class="detail-box">
                    ...
                    <p>
                      Ici vous trouverez les differents medicaments,supplements et vitamines disponible dans les pharmacies tunisiennes 
                    </p>
                    <div>
                      <a href="Connexion_User.php">
                        Acheter Mainetenant
              ...
              <div class="row">
                ...
                <div class="col-md-8">
                  <div class="detail-box">
                    ...
                    <p>
                    Here you will find the different medicines, supplements and vitamins available in Tunisian pharmacies 
                    </p>
                    <div>
                      <a href="Connexion_User.php">
                        Buy Now
      ...
      <div class="feature_container">
        <div class="box">
          ...
          <div class="detail-box">
            ...
            <p>
              Notre Livraison ne depasse pas les 24h
            </p>
          </div>
        </div>
        <div class="box">
          ...
          <div class="detail-box">
            ...
            <p>
              Tous nos pharmacies sont licensiés de l'etat
            </p>
          </div>
        </div>
        <div class="box">
          ...
          <div class="detail-box">
            ...
            <p>
              Notre site est fonctionelle 24/7 
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-lg-3 col-md-5 offset-md-2">
          <div class="detail-box">
            ...
            <p>
              *s'il y a pas de reduction deja
            </p>
            <div>
              <a href="Connexion_User.php">
                Acheter Maintenat
  ...
  <section class="about_section layout_padding">
    <div class="container">
      ...
      <div class="detail-box">
        <p>
        Dweya est une platforme de vente en ligne de medicaments élaboré par deux etudiants de l'Enit   
        afin de faciliter l'achats des produits medicales en ligne et donnés la possibilités au utilisateurs de passer des commmandes en ligne.
        </p>
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <div class="client_container layout_padding2">
              <div class="client_detail">
                <p>
                  Cette platforme facilite enormement l'achat des medicaments specialements pour les gens qui ne peuvent pas sortir.
                </p>
              </div>
              <div class="client_box ">
                <div class="img-box">
                  <img src="images/client.png " width="150px">
                </div>
                <div class="name">
                  <h5>
                    Olfa Ben Salem
          ...
          <div class="carousel-item">
            <div class="client_container layout_padding2">
              <div class="client_detail">
                <p>
                Cette platforme est facile a utilisé et ne demande pas beaucoup de connaisances.
                </p>
              </div>
              <div class="client_box ">
                <div class="img-box">
                  <img src="images/client1.png " width="150px">
                </div>
                <div class="name">
                  <h5>
                    Ali Ben Salah
          ...
          <div class="carousel-item">
            <div class="client_container layout_padding2">
              <div class="client_detail">
                <p>
                  C'est une nouvelle methode efficace pour avoir accées plus facilement au medicaments.J'aime bien l'idée!
                </p>
              </div>
              <div class="client_box ">
                <div class="img-box">
                  <img src="images/client2.png " width="150px">
                </div>
                <div class="name">
                  <h5>
                    Mouhamed Amdouni
...
?>
  ...
  <script type="text/javascript" src="Commerce en ligne/js/jquery-3.4.1.min.js"></script>
  <script type="text/javascript" src="Commerce en ligne/js/bootstrap.js"></script>
  <script type="text/javascript" src="Commerce en ligne/https://cdnjs.cloudflare.com/ajax/libs/OwlCarousel2/2.2.1/owl.carousel.min.js">
  </script>
